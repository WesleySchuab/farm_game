## Estado de arar a terra
## Gerencia a animação e comportamento quando o jogador usa a enxada
extends NodeState
...
## Determina a animação de arar baseado na direção que o jogador está olhando
func _on_enter() -> void:
